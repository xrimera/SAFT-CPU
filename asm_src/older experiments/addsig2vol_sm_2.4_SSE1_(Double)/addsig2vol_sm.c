  #include "mex.h"
		...
		void as2v_sm(double* a, double* b, int c, double* d, double* e,
				 ...
				 int nrhs, const mxArray* prhs[])
		{
			...
			as2v_sm(mxGetPr(out),mxGetPr(AScan),n_AScan,mxGetPr(buffer),mxGetPr(pix_vect),n_X,mxGetPr(rec_pos),mxGetPr(send_pos),mxGetPr(speed),mxGetPr(res),mxGetPr(timeint),mxGetPi(AScan),mxGetPi(buffer),mxGetPi(out),n_Y,n_Z,mxGetPr(IMAGE_SUM),mxGetPi(IMAGE_SUM),qwordbuffer);

...
_as2v_complex:
	...
	jmp interpol
     ...
     ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
     ;;;Xsum path
	mov dword [esp+100],eax   ;width buffer
   ...
   Z_loop:
	...
	;;;;;;;;;;;;;;;;;;;;;;;;
	;rangecheck pixel 1
	 cmp eax,dword [esp+100]	 ;n_Ascan *5      ;cmp eax,dword [esp+36] ;n_Ascan
	...
	rangecheck_pixel_2:
	 ...
	 cmp eax,dword [esp+100]	;n_Ascan *5   ;cmp eax,[esp+36]    ;n_Ascan
	...
	;mov eax,[esp+100] ;out width (previous test)

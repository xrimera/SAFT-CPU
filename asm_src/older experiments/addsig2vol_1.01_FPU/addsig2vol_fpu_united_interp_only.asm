...
_as2v_complex:
   ...
   wdh_interpol:
       ...
       ;fld1
       ;,fld1
       ;fadd st0,st1              ;st1=1+1
       ;fdivp st1,st0             ;1/2
       ;fadd st0,st5              ;index + 0.5 -> ceil
       fist dword [esp+8]	 ;NOT POP!
				 ; index_value 0....xxxx (width_buffer overidden)
				 ; round CEILING!
       ;fsub st0,st5              ;recover org value
     ...
     ;inrange_interpol:
       ...
       mov ebx,[esp+32]       ;*buffer_real[index_aktual] -> Ascan               NP
       ...
       mov ebx,[esp+72]       ;*buffer_complex[index_aktual]               NP
     ...
     ir_interp_real:
       ...
       fstp st0
       fstp st0 	      ;only load: st0-2=receiverpos st3=mulfactor  st4=0.5

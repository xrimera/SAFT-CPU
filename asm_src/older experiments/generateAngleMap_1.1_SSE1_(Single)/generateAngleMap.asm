...
;Anmerkung: 3 Divps durch mulps mit recip. ersetzen.
...
_gam:
   ...
   Z_loop:
     ...
     movaps xmm5,xmm6
     mulps xmm5,xmm5	  ; Z²_ps,Z²_pr,Y²_ps,Y²_pr
     movaps xmm4,xmm5
     shufps xmm4,xmm4,78  ; 0100 1110b ->Y²_ps,Y²_pr,Z²_ps,Z²_pr
     addps xmm5,xmm4	  ; Y²+Z²_ps,Y²+Z²_pr,Y²+Z²_ps,Y²+Z²_pr      XMM5!!!!
	 ...
	 ;vabs
	 movaps xmm3,xmm4     ;
	 mulps xmm3,xmm3      ; X²_sp1,X²_rp1,X²_sp0,X²_rp0,
	 ...
	 ;0....1 to Map(0...end)
	 movaps xmm3,xmm7
	 shufps xmm3,xmm3,255 ; 1111 1111b -> mul_fact,mul_fact,mul_fact,mul_fact
	 mulps	xmm4,xmm3     ; 2999* 0...1

	 ;P0 -> get map value write to bild
	 cvtss2si eax,xmm4    ; index_value P0

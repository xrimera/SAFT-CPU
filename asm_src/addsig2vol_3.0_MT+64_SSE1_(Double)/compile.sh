...
nasm -DISUNIX=1 -f elf64 addsig2vol_3_64.asm -o./addsig2vol_3_64.o
mkoctfile --mex -DBUILDMEX -v -I. -I/usr/include/octave-4.0.3/octave/ -I./munit/ timestats.c threadstats.c addsig2vol_3_mex.c ./munit/munit.c addsig2vol_3.c as2v_array.c -o ./addsig2vol_3_mex ./addsig2vol_3_64.o
...
gcc -g -c -I./* -I/usr/include/octave-4.0.3/octave/ -I/usr/include as2v_array.c  -o ./builds/as2v_array.o
gcc -g -c -I./* -I/usr/include timestats.c  -o ./builds/timestats.o
gcc -g -c -I./* -I/usr/include threadstats.c  -o ./builds/threadstats.o
...
gcc -o ./builds/addsig2vol_3_asm.o ./addsig2vol_3_64.o ./builds/addsig2vol_3_unittests.o ./builds/munit.o ./builds/as2v_array.o ./builds/timestats.o ./builds/threadstats.o ./builds/addsig2vol_3_asm.o  -lm -lpthread -o ./builds/linkedasm
